...
public struct QueryScreenplayElementsIntent: AppIntent {
  ...
  @Parameter(
    title: "Document ID",
    description:
      "The persistent identifier of the screenplay document to query (as JSON-encoded string)"
  )
  ...
  > {
    ...
    let filter: ElementFilter? = {
      ...
      guard elementTypes != nil || chapterIndex != nil || characterName != nil || searchText != nil
      else {
        return nil
      }
