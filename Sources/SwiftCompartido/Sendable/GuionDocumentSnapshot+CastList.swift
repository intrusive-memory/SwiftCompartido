...
extension GuionDocumentSnapshot {
    ...
    public func generateCastList(
        ...
        progress?.update(
            ...
            additionalInfo: "ℹ️ Foundation Models framework is not available. Cast list generation requires iOS 26.2+ or macOS 26.0+",
            force: true
        )
        return nil
        #endif
...
public enum CastListGenerationError: LocalizedError {
    ...
    public var errorDescription: String? {
        ...
        case .appleIntelligenceUnavailable:
            return "Apple Intelligence is not available on this device. Cast list generation requires iOS 26.2+ or macOS 26.0+ with Apple Intelligence enabled."
