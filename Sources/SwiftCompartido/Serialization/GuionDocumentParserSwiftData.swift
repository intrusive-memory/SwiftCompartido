...
import Foundation
  ...
  public class GuionDocumentParserSwiftData {
    ...
    @MainActor public static func parse(
      script: GuionParsedElementCollection, in modelContext: ModelContext,
      generateSummaries: Bool = false
    ) async -> GuionDocumentModel {
      return await parse(
        script: script, in: modelContext, generateSummaries: generateSummaries, progress: nil)
    }
    ...
    @MainActor public static func parse(
      ...
      return await GuionDocumentModel.from(
        script, in: modelContext, generateSummaries: generateSummaries, progress: progress)
    }
    ...
    @MainActor public static func loadAndParse(
      from url: URL, in modelContext: ModelContext, generateSummaries: Bool = false
    ) async throws -> GuionDocumentModel {
      return try await loadAndParse(
        from: url, in: modelContext, generateSummaries: generateSummaries, progress: nil)
    }
    ...
    @MainActor public static func loadAndParse(
      ...
      case "highland":
        ...
        return await parse(
          script: script, in: modelContext, generateSummaries: generateSummaries, progress: progress
        )
      case "textbundle":
      ...
      case "fdx":
        ...
        do {
          ...
          return await GuionDocumentModel.from(
            screenplay, in: modelContext, generateSummaries: generateSummaries, progress: progress)
        } catch {
    ...
    public static func toFountainScript(from model: GuionDocumentModel)
