...
@available(
  *, deprecated, message: "Use GuionJSONSerializer instead. TextPack format is deprecated."
)
public struct TextPackWriter {
  ...
  public static func createTextPack(from screenplay: GuionParsedElementCollection) throws
    -> FileWrapper
  {
  ...
  private static func createResourcesDirectory(from screenplay: GuionParsedElementCollection) throws
    -> FileWrapper
  {
  ...
  private static func extractCharacterData(from screenplay: GuionParsedElementCollection)
    -> TextPackCharacterList
  {
  ...
  private static func extractLocationData(from screenplay: GuionParsedElementCollection)
    -> LocationList
  {
