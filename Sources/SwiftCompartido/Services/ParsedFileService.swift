...
public enum ParsedFileServiceError: Error, LocalizedError {
  ...
  public var errorDescription: String? {
    ...
    case .parsingFailed(let url, let underlyingError):
      return
        "Failed to parse screenplay at \(url.lastPathComponent): \(underlyingError.localizedDescription)"
  ...
  public var recoverySuggestion: String? {
    ...
    case .parsingFailed:
      return
        "Ensure the file is a valid screenplay format (Fountain, FDX, PDF, Markdown, Highland, or TextBundle)"
