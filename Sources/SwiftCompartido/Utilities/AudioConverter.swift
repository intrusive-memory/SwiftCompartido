...
public struct AudioConverter {
    ...
    public static func convert(_ inputData: Data, to outputFormat: AudioExportFormat) throws -> Data {
        ...
        while inputFile.framePosition < inputFile.length {
            let framesToRead = min(bufferSize, AVAudioFrameCount(inputFile.length - inputFile.framePosition))
    ...
    /// - Throws: Conversion errors
    public static func concatenate(_ audioDataArray: [Data], to outputFormat: AudioExportFormat) async throws -> Data {
