...
<p align="center">
    ...
    <img src="https://img.shields.io/badge/Version-3.4.2-blue.svg" />
</p>
...
```swift
dependencies: [
    .package(url: "https://github.com/intrusive-memory/SwiftCompartido.git", from: "3.4.2")
]
```
...
3. Select version: **3.4.2** or later
