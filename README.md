...
<p align="center">
    ...
    <img src="https://img.shields.io/badge/Version-7.1.0--dev-blue.svg" />
</p>
...
**Version 7.1.0-dev** (development) is the next release in progress. Latest release: **7.1.0** adds telemetry instrumentation, memory manager improvements, and comprehensive migration tests. Key highlights:
