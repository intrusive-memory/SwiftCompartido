...
<p align="center">
    ...
    <img src="https://img.shields.io/badge/Version-7.2.2--dev-blue.svg" />
</p>
...
**Version 7.2.2-dev** (development) is the next cycle in progress. Latest release: **7.2.2** hardens the Fountain parser so emphasis-wrapped direction lines (e.g. `**END OF SCENE.**`) are no longer mis-typed as character cues. Key highlights:
