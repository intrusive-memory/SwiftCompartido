...
<p align="center">
    ...
    <img src="https://img.shields.io/badge/Version-4.4.0-blue.svg" />
</p>
...
```swift
dependencies: [
    .package(url: "https://github.com/intrusive-memory/SwiftCompartido.git", from: "4.4.0")
]
```
...
3. Select version: **4.4.0** or later
