...
struct ElementOrderingTests {
  ...
  func testOrderIndexAssignment() async throws {
    ...
    for (index, element) in document.elements.enumerated() {
      ...
      #expect(
        ...
        "Element at position \(index) should have orderIndex \(index + 1) (1-based)")
    }
  }
  ...
  func testOrderIndexStartsAtZero() async throws {
    ...
    #expect(
      document.elements.first?.orderIndex == 1, "First element should have orderIndex 1 (1-based)")
  }
  ...
  func testElementOrderMatchesOriginal() async throws {
    ...
    for (index, element) in document.elements.enumerated() {
      #expect(
        element.elementText == originalTexts[index],
  ...
  func testRoundTripConversionPreservesOrder() async throws {
    ...
    #expect(
      convertedBack.elements.count == 100,
  ...
  func testSingleElementOrder() async throws {
    ...
    #expect(
      document.elements.first?.orderIndex == 1, "Single element should have orderIndex 1 (1-based)")
  }
  ...
  func testMixedElementTypesPreserveOrder() async throws {
    ...
    for (index, element) in document.elements.enumerated() {
      #expect(
        element.elementText == elements[index].elementText,
  ...
  func testFiveChaptersOrdering() async throws {
    ...
    for chapterNum in 1...5 {
      ...
      // Chapter heading
      #expect(
        document.elements[baseIndex].chapterIndex == chapterNum,
        "Chapter \(chapterNum) heading has chapterIndex=\(chapterNum)")
      #expect(
        document.elements[baseIndex].orderIndex == 1,
      ...
      for i in 1...3 {
        ...
        #expect(
          document.elements[elemIndex].chapterIndex == chapterNum,
          "Chapter \(chapterNum) element \(i) has chapterIndex=\(chapterNum)")
        #expect(
          document.elements[elemIndex].orderIndex == i + 1,
