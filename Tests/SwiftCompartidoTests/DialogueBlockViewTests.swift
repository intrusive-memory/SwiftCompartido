...
struct DialogueBlockViewTests {
    ...
    func testDialogueBlockNonDialogue() {
        let container = try! makeTestContainer()
        let action = makeElement(in: container.mainContext, text: "John enters.", type: .action, order: 0)
    ...
    func testGroupDialogueBlocksWithParenthetical() {
        let container = try! makeTestContainer()
        let char = makeElement(in: container.mainContext, text: "JOHN", type: .character, order: 0)
        let paren = makeElement(in: container.mainContext, text: "(smiling)", type: .parenthetical, order: 1)
    ...
    func testGroupDialogueBlocksSeparatesNonDialogue() {
        let container = try! makeTestContainer()
        let action1 = makeElement(in: container.mainContext, text: "John enters.", type: .action, order: 0)
        let char = makeElement(in: container.mainContext, text: "JOHN", type: .character, order: 1)
        let dialogue = makeElement(in: container.mainContext, text: "Hello", type: .dialogue, order: 2)
        let action2 = makeElement(in: container.mainContext, text: "John exits.", type: .action, order: 3)
    ...
    func testGroupDialogueBlocksOrphanedParenthetical() {
        let container = try! makeTestContainer()
        let paren = makeElement(in: container.mainContext, text: "(confused)", type: .parenthetical, order: 0)
    ...
    func testGroupDialogueBlocksSceneHeadingSeparator() {
        ...
        let char1 = makeElement(in: container.mainContext, text: "JOHN", type: .character, order: 0)
        let dialogue1 = makeElement(in: container.mainContext, text: "Hello", type: .dialogue, order: 1)
        let scene = makeElement(in: container.mainContext, text: "INT. OFFICE - DAY", type: .sceneHeading, order: 2)
    ...
    func testGroupDialogueBlocksTransitionSeparator() {
        let container = try! makeTestContainer()
        let char1 = makeElement(in: container.mainContext, text: "JOHN", type: .character, order: 0)
        let dialogue1 = makeElement(in: container.mainContext, text: "Goodbye", type: .dialogue, order: 1)
        let transition = makeElement(in: container.mainContext, text: "CUT TO:", type: .transition, order: 2)
        let char2 = makeElement(in: container.mainContext, text: "MARY", type: .character, order: 3)
    ...
    func testGroupDialogueBlocksMultipleParentheticals() {
        let container = try! makeTestContainer()
        let char = makeElement(in: container.mainContext, text: "JOHN", type: .character, order: 0)
        let paren1 = makeElement(in: container.mainContext, text: "(hesitant)", type: .parenthetical, order: 1)
        let dialogue1 = makeElement(in: container.mainContext, text: "Well...", type: .dialogue, order: 2)
        let paren2 = makeElement(in: container.mainContext, text: "(smiling)", type: .parenthetical, order: 3)
    ...
    func testDialogueBlockViewComplexBlock() {
        ...
        let block = DialogueBlock(elements: [char, paren1, dialogue1, paren2, dialogue2], isDialogueBlock: true)
        _ = DialogueBlockView(block: block)
            .environment(\.screenplayFontSize, 12)
    ...
    func testFullDialogueScene() {
        ...
        let scene = makeElement(in: container.mainContext, text: "INT. OFFICE - DAY", type: .sceneHeading, order: 0)
        let action1 = makeElement(in: container.mainContext, text: "John enters.", type: .action, order: 1)
        let char1 = makeElement(in: container.mainContext, text: "JOHN", type: .character, order: 2)
        let dialogue1 = makeElement(in: container.mainContext, text: "Hello everyone.", type: .dialogue, order: 3)
        let action2 = makeElement(in: container.mainContext, text: "Mary looks up.", type: .action, order: 4)
        let char2 = makeElement(in: container.mainContext, text: "MARY", type: .character, order: 5)
        let paren = makeElement(in: container.mainContext, text: "(smiling)", type: .parenthetical, order: 6)
        let dialogue2 = makeElement(in: container.mainContext, text: "Hi John!", type: .dialogue, order: 7)
