...
struct FountainParserTests {
  ...
  @Test func testSynopsis() {
    ...
    #expect(
      synopses[0].elementText.contains("John meets Jane"),
      "Synopsis text should contain expected content")
  }
  ...
  @Test func testForcedTransition() {
    ...
    #expect(
      transitions[0].elementText.contains("SMASH CUT TO:"),
      "Transition text should contain expected content")
  }
