...
struct PreSceneBoxTests {
    ...
    func testPreSceneBoxSpecialCharacters() throws {
        let container = try makeTestContainer()
        let element = makeElement(in: container.mainContext, text: "FADE IN: © 2025 — All Rights Reserved™")
    ...
    func testPreSceneBoxCommentElements() throws {
        let container = try makeTestContainer()
        let element = makeElement(in: container.mainContext, text: "/* Note to director */", type: .comment)
    ...
    func testPreSceneBoxMixedElementTypes() throws {
        ...
        let elements = [
            ...
            makeElement(in: container.mainContext, text: "/* Production note */", type: .comment, order: 1),
    ...
    func testPreSceneBoxProductionNotes() throws {
        ...
        let note2 = makeElement(in: container.mainContext, text: "/* Filmed on location */", type: .comment, order: 1)
        let note3 = makeElement(in: container.mainContext, text: "= Opening establishes tone", type: .synopsis, order: 2)
