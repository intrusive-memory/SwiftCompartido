...
struct GuionElementsListTests {
    ...
    func testGuionElementsListChapterOrdering() throws {
        ...
        let ch1_el1 = GuionElementModel(elementText: "Ch1 El1", elementType: .action, chapterIndex: 0, orderIndex: 0)
        let ch1_el2 = GuionElementModel(elementText: "Ch1 El2", elementType: .action, chapterIndex: 0, orderIndex: 1)
        let ch2_el1 = GuionElementModel(elementText: "Ch2 El1", elementType: .action, chapterIndex: 1, orderIndex: 0)
        let ch2_el2 = GuionElementModel(elementText: "Ch2 El2", elementType: .action, chapterIndex: 1, orderIndex: 1)
