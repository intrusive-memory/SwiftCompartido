...
This document describes the multi-layered approach to enforcing minimum platform versions (macOS/iOS 26.0+) for this library.

## Overview

This library requires **macOS 26.0+ / iOS 26.0+** (released September 2025) as the minimum deployment target. This guide shows how to prevent code using older platform versions from being committed.
